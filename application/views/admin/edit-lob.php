  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit LINE OF BUSINESS</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Edit LINE OF BUSINESS</h3>
            </div>
            <!-- /.box-header -->
                  ...
                  <div class="box-body">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="txtlob" value="<?php echo $cnt['lob_name']; ?>" class="form-control" placeholder="line of business Name">
                      </div>
                    </div>
