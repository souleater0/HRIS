...
class Credentials extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view('admin/add-credential');
        $this->load->view('admin/footer');
    }

    public function manage_credential()
    {
        $data['content']=$this->Credentials_model->select_credential();
        $this->load->view('admin/header');
        $this->load->view('admin/manage-credential',$data);
        $this->load->view('admin/footer');
    }
