...
class Leave extends CI_Controller {
    ...
    {
        $data['leavetype']=$this->Leavetype_model->select_leavetype();
    ...
    public function insert()
    {
        ...
        $this->form_validation->set_rules('slcleavetype', 'leave type', 'required');
        ...
        $leavetype=$this->input->post('slcleavetype');
        $data=$this->Leave_model->insert_leave(array('staff_id'=>$staff,'leave_reason'=>$reason,'leave_from'=>$lfrom,'leave_to'=>$lto,'leave_type_id'=>$leavetype,'description'=>$desc,'applied_on'=>date('Y-m-d')));
        if($data==true)
        {
